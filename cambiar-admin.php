<?php
   ...
   if(@$_SESSION['tipo']!="admin")
    ...
    if(strlen($_POST['password'])==2**5) 
        $sql = "UPDATE `usuario` SET `nombre` = '".$_POST['nombre']."', `ape_pat` = '".$_POST['ape_pat']."', `ape_mat` = '".$_POST['ape_mat']."', `email` = '".$_POST['email']."', `telefono` = '".$_POST['telefono']."', `fecha` = '".$_POST['fecha']."', `password` = '".$_POST['password']."', `gustos` = '".$_POST['gustos']."', `tipo` = '".$_POST['tipo']."' WHERE `usuario`.`idu` = ".$_SESSION['idu-act'];
    else
        $sql = "UPDATE `usuario` SET `nombre` = '".$_POST['nombre']."', `ape_pat` = '".$_POST['ape_pat']."', `ape_mat` = '".$_POST['ape_mat']."', `email` = '".$_POST['email']."', `telefono` = '".$_POST['telefono']."', `fecha` = '".$_POST['fecha']."', `password` = MD5('".$_POST['password']."'), `gustos` = '".$_POST['gustos']."', `tipo` = '".$_POST['tipo']."' WHERE `usuario`.`idu` = ".$_SESSION['idu'];
